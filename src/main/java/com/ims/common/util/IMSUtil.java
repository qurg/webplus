...
public class IMSUtil {
	...
	public static boolean contains(String str,String separateStr){
		if(IMSUtil.isNotAnyEmpty(str,separateStr)){
			List<String> strList=IMSFormater.separatStringToList(separateStr);
	...
	public static boolean contains(String str,List<String> strList){
		if(IMSUtil.isNotAnyEmpty(str,strList)){
	...
	public static List removeRepeat(List dataList){
		if(IMSUtil.isNotEmpty(dataList)){
